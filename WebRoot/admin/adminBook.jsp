...
<table width="777" height="609"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="tableBorder_LTR">
      <tr>
        <td height="30" align="center" bgcolor="#eeeeee">≡≡≡ <span class="word_grey"><img alt="" src="../Images/plus1.gif" width="18" height="18"><a href="book_add.jsp">添加图书信息</a></img></span> ≡≡≡</td>
      </tr>
    </table>
...
for(int i=1;i<=pagesize;i++){
	  ...
	  --%>
              ...
              <tr style="padding:5px;">
                ...
                <td align="center"><a href="book_detail.jsp?ISBN=<%%>"><%%></a></td>
                <td align="center"><%%></td>
                <td align="center"><%%></td>
                <td align="center"><%%></td>
                <td align="center"><a href="book_modify.jsp?ISBN=<%%>"><img src="../Images/modify.gif" width="15" height="15"></a></td>
                <td align="center"><a href="book_del.jsp?ISBN=<%%>"><img src="../Images/del.gif" width="16" height="16"></a></td>
              </tr>
<%--
	try{
		if(!rs.next()){break;}
